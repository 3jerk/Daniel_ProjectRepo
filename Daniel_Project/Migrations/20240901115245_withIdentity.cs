...
namespace Daniel_Project.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilityDateFrom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FacilityDateTo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Administrators", x => x.BookingID);
                });
